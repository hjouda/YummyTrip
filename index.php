...
<head>
    ...
    <link rel="stylesheet" type="text/css" href="./plugins/morphin_page/css/demo.css" />
    <link rel="stylesheet" type="text/css" href="./plugins/morphin_page/css/normalize.css" />
...
<body class="demo-2 loading">
    <!--http://webdesignerwall.com/tutorials/four-elements-great-responsive-menus tuto de la nav avec les explications-->
    <main id="mpmain">
        <div class="content content--intro">

            <div class="content__inner">
                <h2 class="content__title">Yummy Trip</h2>
                <h3 class="content__subtitle">Taste the world ! Enjoy your trip!</h3>
        ...
        <div class="content content--fixed">
            <div class="content__inner">
                <nav class="menu">
                    <a class="menu__item" href="NotreMonde.php" style="background: no-repeat 0% 14%/94% url(./plugins/morphin_page/img/paint1.svg);"><span>Notre Monde</span></a>
                    <a class="menu__item" href="NosDestinations.php" style="background: no-repeat 0% 14%/94% url(./plugins/morphin_page/img/paint1.svg);"><span>Nos destinations</span></a>
        ...
        <script src="./plugins/morphin_page/js/imagesloaded.pkgd.min.js"></script>
        <script src="./plugins/morphin_page/js/charming.min.js"></script>
        <script src="./plugins/morphin_page/js/anime.min.js"></script>
        <script src="./plugins/morphin_page/js/demo2.js"></script>
    </main>
</body>
